...
from src.grpc.server import review_pb2 as src_dot_grpc_dot_review__pb2
...
class ReviewServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FingerprintCallback = channel.unary_unary(
                ...
                request_serializer=src_dot_grpc_dot_review__pb2.FingerprintCallbackRequest.SerializeToString,
...
def add_ReviewServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FingerprintCallback': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=src_dot_grpc_dot_review__pb2.FingerprintCallbackRequest.FromString,
...
class ReviewService(object):
    ...
    def FingerprintCallback(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ReviewService/FingerprintCallback',
            src_dot_grpc_dot_review__pb2.FingerprintCallbackRequest.SerializeToString,
